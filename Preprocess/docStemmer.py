#class to read all files in directory and stem them
#handles reutrrs format which is a tagged line file
#and a structure where files are listed in each directory
#it takes this info and generates stemmed content in two formats
#first is a tagged line document where one document has every document one per line
#the other is a directory where each file is  a seperate file
import gensim
