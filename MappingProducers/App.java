//the main file which uses my file mapping classes to represent mapping generated by various algorithms described in paper
//we use lucene to index document set so we can quickly determine if a file has a word
//see the paper to see which algorithms we use to generalize words to senses
