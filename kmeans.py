...
#Output purity,rand index and fscore of clusters for each given csv file
#
import re
...
def main():
    ...
    csvFiles = [
        "TestDoc2Vec.csv",
	   # "TestSarGreedyMapping.csv","1TestSarGreedyMapping.csv",
       # "2TestSarGreedyMapping.csv","3TestSarGreedyMapping.csv",
	#   "TestHothoMapping.csv",
       #  "TestHothoMapping.csv","TestRecuperoMapping.csv", "TestBaseMapping.csv", "TestAllMapping.csv"
    ]
    lsiFiles = [
       # "LSI_1TestSarMapping.csv", "LSI_2TestSarMapping.csv", "LSI_3TestSarMapping.csv", "LSI_TestSarMapping.csv",
    #    "LSI_TestSarGreedyMapping.csv","LSI_1TestSarGreedyMapping.csv",# "LSI_2TestSarGreedyMapping.csv", "LSI_3TestSarGreedyMapping.csv",
       # "LSI_TestFodehMapping.csv", "LSI_TestRecuperoMapping.csv",
       # "LSI_TestAllMapping.csv", "LSI_TestBaseMapping.csv", 
	   
	#   "LSI_TestBaseMapping.csv"
    ]
    if(useLsi =='1'):
